...
def dashboard_artifact_contracts() -> Dict[str, ArtifactContract]:
    return {
        ...
        "weekly_unified_evidence": ArtifactContract(
            artifact_key="weekly_unified_evidence",
            label="Weekly Unified Evidence",
            filename="weekly_unified_evidence.json",
            format="json",
            required_fields=("row_count", "rows"),
            freshness_hours=168,
            missing_status="warning",
            fallback_filename="weekly_review_summary.json",
            fallback_section="unified_evidence_rows",
            inherit_generated_at_from="weekly_review_summary",
            inherit_schema_version_from="weekly_review_summary",
        ),
        "weekly_blocked_vs_allowed_expost": ArtifactContract(
            artifact_key="weekly_blocked_vs_allowed_expost",
            label="Weekly Blocked vs Allowed Ex-Post",
            filename="weekly_blocked_vs_allowed_expost.json",
            format="json",
            required_fields=("row_count", "rows"),
            freshness_hours=168,
            missing_status="warning",
            fallback_filename="weekly_review_summary.json",
            fallback_section="blocked_vs_allowed_expost_review",
            inherit_generated_at_from="weekly_review_summary",
            inherit_schema_version_from="weekly_review_summary",
        ),
        "weekly_trading_quality_evidence": ArtifactContract(
            artifact_key="weekly_trading_quality_evidence",
            label="Weekly Trading Quality Evidence",
            filename="weekly_trading_quality_evidence.csv",
            format="csv",
            required_columns=("portfolio_id", "market", "evidence_layer", "sample_count"),
            freshness_hours=168,
            missing_status="warning",
            fallback_filename="weekly_review_summary.json",
            fallback_section="trading_quality_evidence",
            inherit_generated_at_from="weekly_review_summary",
            inherit_schema_version_from="weekly_review_summary",
        ),
        "weekly_candidate_model_review": ArtifactContract(
            artifact_key="weekly_candidate_model_review",
            label="Weekly Candidate Model Review",
            filename="weekly_candidate_model_review.csv",
            format="csv",
            required_columns=("portfolio_id", "market", "review_label"),
            freshness_hours=168,
            missing_status="warning",
            fallback_filename="weekly_review_summary.json",
            fallback_section="candidate_model_review",
            inherit_generated_at_from="weekly_review_summary",
            inherit_schema_version_from="weekly_review_summary",
        ),
        ...
        "weekly_attribution_summary": ArtifactContract(
            artifact_key="weekly_attribution_summary",
            label="Weekly Attribution Summary",
            filename="weekly_attribution_summary.csv",
            format="csv",
            required_columns=("portfolio_id", "market"),
            freshness_hours=168,
            missing_status="warning",
            fallback_filename="weekly_review_summary.json",
            fallback_section="attribution_summary",
            inherit_generated_at_from="weekly_review_summary",
            inherit_schema_version_from="weekly_review_summary",
        ),
