...
log = get_logger("tools.run_investment_opportunity")
...
def main(argv: list[str] | None = None) -> None:
    ...
    opportunity_cfg_path = str(
        _resolve_project_path(
            args.opportunity_config or str(ibkr_cfg.get("investment_opportunity_config", f"config/investment_opportunity_{market.lower()}.yaml"))
        )
    )
