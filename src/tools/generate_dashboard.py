    ...
    enriched.update(
        {
            ...
            "seed_proposals": list(expansion_summary.get("seed_proposals") or [])[:20],
            "seed_proposal_count": int(expansion_summary.get("seed_proposal_count", 0) or 0),
            "manual_seed_proposal_count": int(expansion_summary.get("manual_seed_proposal_count", 0) or 0),
